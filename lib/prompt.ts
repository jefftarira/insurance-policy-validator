...
- Paso 3: Cuando recibas los resultados, infiere vigencia: si valid_until < today_date, la póliza está VENCIDA. Si está vigente, llama compute_copay con admission_cost_usd del payload (suma de las consultas/evaluaciones por diagnóstico — ver array "diagnoses" para el detalle) y los datos de la póliza.
